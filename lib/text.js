...
│ *${p+=1}.* ${prefix}nhentai _codeNuclear😏_ *premium*
│ *${p+=1}.* ${prefix}animesearch _query_ *error*
│ *${p+=1}.* ${prefix}ppcouple
...
const ingfo = `Ingin Bertanya tanya tentang Bot? join https://chat.whatsapp.com/EI4gfioqBWGHpnJpLeMuaL`
