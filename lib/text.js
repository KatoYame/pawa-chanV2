...
│ *${p+=1}.* ${prefix}nsfwspank
│ *${p+=1}.* ${prefix}nsfwblowjob
│ *${p+=1}.* ${prefix}nsfwcumarts
│ *${p+=1}.* ${prefix}nsfweroyuri
│ *${p+=1}.* ${prefix}nsfweroneko
│ *${p+=1}.* ${prefix}nsfwerokemonomimi
│ *${p+=1}.* ${prefix}nsfwerokitsune
│ *${p+=1}.* ${prefix}nsfwero
│ *${p+=1}.* ${prefix}nsfwfeet
│ *${p+=1}.* ${prefix}nsfwerofeet
│ *${p+=1}.* ${prefix}nsfwfemdom
│ *${p+=1}.* ${prefix}nsfwfutanari
│ *${p+=1}.* ${prefix}nsfwhentai
│ *${p+=1}.* ${prefix}nsfwholoero
│ *${p+=1}.* ${prefix}nsfwholo
│ *${p+=1}.* ${prefix}nsfwketa
│ *${p+=1}.* ${prefix}nsfwkitsune
│ *${p+=1}.* ${prefix}nsfwkemonomimi
│ *${p+=1}.* ${prefix}nsfwpussyart
│ *${p+=1}.* ${prefix}nsfwgirlsolo
│ *${p+=1}.* ${prefix}nsfwtits
│ *${p+=1}.* ${prefix}nsfwtrap
│ *${p+=1}.* ${prefix}nsfwyuri
│ *${p+=1}.* ${prefix}nsfwavatar
│ *${p+=1}.* ${prefix}nsfwboobs
│ *${p+=1}.* ${prefix}nsfwcumsluts
│ *${p+=1}.* ${prefix}nsfwlesbian
│ *${p+=1}.* ${prefix}armpits *premium*
│ *${p+=1}.* ${prefix}thighss *premium*
│ *${p+=1}.* ${prefix}booty *premium*
│ *${p+=1}.* ${prefix}sideoppai *premium*
│ *${p+=1}.* ${prefix}ahegao *premium*
│ *${p+=1}.* ${prefix}pantsu *premium*
│ *${p+=1}.* ${prefix}ass *premium*
├────────────────────
│ *「パ ワ ー」*
└────────────────────
...
*「S&K」*
❏ Bot akan leave jika sudah mencapai batas hari (30 hari)
❏ Jika bot di kick, di anggap sudah habis masa pakai nya (kecuali sewa selamanya)
