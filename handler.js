            ...
            try {
            	...
            	break
       	         ...
       	         Client.sendFileFromUrl(from, thumbnail, 'p.jpg', caption, message)
                        ...
                        data.reply(`Maaf anime ${data.body} tidak ditemukan di web kusonime`)
                    }
  	              break
					case 'anime':
                    try {
					...
					try {
                    if(isLimit(data.sender)) return data.reply(mess.limit)
                    data.reply(mess.wait) //https://leyscoders-api.herokuapp.com/api/ppcouple?apikey=YOUR_APIKEY
				    ...
				    try{
                    if(isLimit(data.sender)) return data.reply(mess.limit)
                    data.reply(mess.wait) //https://dapuhy-api.herokuapp.com/api/randomimage/couple?apikey=YOUR_APIKEY
