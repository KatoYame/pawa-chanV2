            ...
            try {
            	...
            	break
                    ...
                    case 'kusonime':
                        ...
                        data.reply(mess.wait)
                        get_result = await fetchJson(`${configs.apiUrl}/api/kusonimesearch?apikey=${configs.LolKey}&q=${data.body}`)
                    ...
                    Client.sendFileFromUrl(from, ini_buffer, 'p.jpg', ini_txt, message)
                    break
					case 'anime':
                    try {
                        if(isLimit(data.sender)) return data.reply(mess.limit)
